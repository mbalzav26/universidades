...
class UniversitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create university" do
    assert_difference("University.count") do
      post universities_url, params: { university: { pais: @university.pais, universidad: @university.universidad } }
    end
  ...
  test "should update university" do
    patch university_url(@university), params: { university: { pais: @university.pais, universidad: @university.universidad } }
